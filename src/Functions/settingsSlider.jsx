...
export const dataCarouselDemo = [
  { title: 'Boroto', rating: 8.0, chapter: 123, images: {background: {id:'', url: Images.carousel01}} },
  { title: 'Naruto', rating: 8.0, chapter: 123, images: {background: {id:'', url: Images.carousel02}} },
  { title: 'Sakura', rating: 8.0, chapter: 123, images: {background: {id:'', url: Images.carousel03}} },
  { title: 'Hanita', rating: 8.0, chapter: 123, images: {background: {id:'', url: Images.carousel04}} },
  { title: 'Sasuke', rating: 8.0, chapter: 123, images: {background: {id:'', url: Images.carousel05}} },
  { title: 'Đệ Tứ', rating: 8.0, chapter: 123, images: {background: {id:'', url: Images.carousel06}} },
]
