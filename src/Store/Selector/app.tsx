...
// export default {
//   DataAllAuthor: DataAllAuthor, DataAllGenre: DataAllGenre, DataAllManga: DataAllManga, DataAllCategory: DataAllCategory, DataAllStatus: DataAllStatus,
//   DataManyManga: DataManyManga, DataOneManga: DataOneManga, DataAllReview: DataAllReview, DataAllComment: DataAllComment,
//   DataAllChapter: DataAllChapter, DataManyChapter: DataManyChapter, DataOneChapter: DataOneChapter,
//   QuantityManga: QuantityManga, QuantityChapter: QuantityChapter,

//   InsertOneEbook: InsertOneEbook,
// }
